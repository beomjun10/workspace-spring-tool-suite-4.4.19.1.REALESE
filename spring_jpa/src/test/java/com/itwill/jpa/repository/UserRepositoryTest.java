...
class UserRepositoryTest extends SpringJpaApplicationTests{
	...
	void customSelect() {
		...
		System.out.println(">>>findByName				:"+userRepository.findByName("김경호20"));
		...
		System.out.println(">>>findFirst2ByNameOrderByUserIdDesc:"+userRepository.findFirst2ByNameOrderByUserIdDesc("김경호20"));
	...
	void update() {
		...
		findUser1.setName("제임수딘");
		findUser1.setEmail("james@gmail.com");
		//userRespository.save(findUser1);
