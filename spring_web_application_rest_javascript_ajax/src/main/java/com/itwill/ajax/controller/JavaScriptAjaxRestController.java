...
public class JavaScriptAjaxRestController {
	...
	public String ajaxRequestPOST(@RequestParam(name = "id",required = false,defaultValue = "") String id) throws Exception{
		String msg="";
		if(id.startsWith("guard")) {
			msg="사용가능";
		}else {
	...
	*/
	...
	@GetMapping(value="01.ajaxRequestGET/{idStr}",produces = "applicaion/json;charset=UTF-8")
	public Map<String, Object> ajaxRequestGET(
			@PathVariable(name="idStr") String idStr) 
							throws Exception {
		int status = 1;
		String msg = "";
	...
	public Map<String, Object> ajaxRequestPOST(@RequestParam(name="id") String idStr){ 
		int status = 1;
		String msg = "";
		Object data = new ArrayList<Object>();
