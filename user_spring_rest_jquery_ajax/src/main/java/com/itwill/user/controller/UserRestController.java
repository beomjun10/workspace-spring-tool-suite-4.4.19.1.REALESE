...
public class UserRestController {
	...
	@LoginCheck
	@GetMapping("/{userId}")
	public ResponseEntity<Response> user_view(@PathVariable(name="userId") String userId) throws Exception{
	...
	public ResponseEntity<Response> user_existed_exception_handler(ExistedUserException e) throws Exception{
		Response response=new Response();
	...
	public ResponseEntity<Response> user_not_found_exception_handler(UserNotFoundException e) throws Exception{
		Response response=new Response();
	...
	public ResponseEntity<Response> user_password_mismatch_handler(PasswordMismatchException e) throws Exception{
		Response response=new Response();
