...
export const product_list_list_view=function(responseJsonObject={}) {
        ...
        <div class="row justify-content-center">
          <div class="col-lg-10">
            ...
            <div class="shop-toolbar padding-bottom-1x mb-2">
              ...
              <div class="column">
                <div class="shop-view"><a class="grid-view" href="#/api/shop-grid-ns"><span></span><span></span><span></span></a><a class="list-view active" href="#/api/shop-list-ns"><span></span><span></span><span></span></a></div>
              </div>
            </div>
            <!-- Product-->
