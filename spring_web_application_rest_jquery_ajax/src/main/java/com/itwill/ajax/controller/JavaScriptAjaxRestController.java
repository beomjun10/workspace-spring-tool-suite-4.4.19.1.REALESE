...
public class JavaScriptAjaxRestController {
	...
	*/
	...
	@PostMapping(value="02.ajaxRequestPOST/{id}",produces = "application/json;charset=UTF-8")
	public Map<String, Object> ajaxRequestPOST(@PathVariable(name="id") String idStr) throws Exception{ 
		int status = 1;
		String msg = "";
		Object data = new ArrayList<Object>();
