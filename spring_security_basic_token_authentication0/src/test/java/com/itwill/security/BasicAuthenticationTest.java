...
public class BasicAuthenticationTest {
   ...
   @LocalServerPort
    ...
    void test_2() {
        ...
        System.out.println("Authorization: Basic "+ Base64.getEncoder().encodeToString(
                "user1:1111".getBytes()));
    ...
    void test_4() {
        TestRestTemplate testClient = new TestRestTemplate("user1", "1111");
        ResponseEntity<String> resp = testClient.postForEntity(greetingUrl(), "guard", String.class);
        assertEquals("hello guard", resp.getBody());
    }
