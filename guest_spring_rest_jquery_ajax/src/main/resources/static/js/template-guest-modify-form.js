			...
			<td><br>
				...
				<table width="590" border="0" cellpadding="0" cellspacing="0">
					<tbody>
						<tr>
							<td align="center">
							<input data-navigate="/guest_modify_action/{{data.[0].guest_no}}" type="button" value="수정" id="btn_guest_modify_action"> &nbsp; 
							<input data-navigate="/guest_list" id="btn_guest_list" type="button" value="목록"></td>
						</tr>
					</tbody>
				</table></td>
		</tr>
