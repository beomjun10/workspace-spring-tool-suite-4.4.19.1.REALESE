...
public class BoardService {
	...
	public Page<Board> findBoardList(Pageable pageable,String searchType,String searchKeyword) throws Exception{
		//게시물검색데이타 얻기
		...
		if(searchType!=null) {
            switch (searchType) {
                case "title":    
                	specification=BoardSpecification.containingTitle(searchKeyword);
                    break;
                case "content": 
                	specification=BoardSpecification.containingContent(searchKeyword);
                    break;
                case "writer": 
                	specification=BoardSpecification.startsWithWriter(searchKeyword);
                    break;
                default:
